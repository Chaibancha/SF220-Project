<script>
  ...
  import './style/forgotpass_style.css'
...
<main>
  ...
  <div class = "change_pass">
    <span id = "citizenID">Citizen ID :</span><input type ="text" placeholder="Citizen ID " name ="citizenID_box" id ="citizenID_box" 
maxlength="13"  bind:value={UserID}>
